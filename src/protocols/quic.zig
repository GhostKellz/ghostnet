...
pub const QuicConnection = struct {
    ...
    pub fn connect(self: *QuicConnection, address: transport.Address) !void {
        ...
        self.quic_conn = try zquic.Connection.Connection.init(self.allocator, .client, params);
    ...
    pub fn accept(self: *QuicConnection, socket: udp.UdpSocket, remote_addr: transport.Address) !void {
        ...
        const params = zquic.Connection.ConnectionParams{};
        self.quic_conn = try zquic.Connection.Connection.init(self.allocator, .server, params);
