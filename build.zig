...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "ghostnet" is the name you will use in your source code to
                // import this module (e.g. `@import("ghostnet")`). The name is
    ...
    // Create zquic integration test
    const zquic_test = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("test_zquic_integration.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "ghostnet", .module = mod },
